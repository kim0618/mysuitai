// Single source of truth for the Builder workspace mode: 'chat' | 'direct-edit' | 'data-binding' | 'preview'.
...
(function () {
  ...
  window.MvpWorkspaceMode = {
    ...
    set(next) {
      if (!['chat', 'direct-edit', 'data-binding', 'preview'].includes(next) || next === mode) return;
